...
DEFAULT_BACKEND_URL = "http://localhost:8000"       # defines a fallback backend server address
...
def health_check() -> Dict[str, Any]:
    ...
    response.raise_for_status()     #checks whether the HTTP request succeeded, otherwise raises an exception
