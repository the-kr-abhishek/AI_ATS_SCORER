...
_ASYMMETRIC_ALGS = ['ES256', 'RS256']     # ALGORITHMS ARE TYPES OF LOCKS

_jwks_client: jwt.PyJWKClient | None = None


def _get_jwks_client() -> jwt.PyJWKClient | None:       # OBJECT REQUIED FOR ASYMMETRIC ALGO. ONLY , IT GIVES PUBLIC KEYS FROM SUPABASE
    global _jwks_client
...
def _verify_token(token: str) -> dict:
    ...
    if alg in _ASYMMETRIC_ALGS:
        ...
        return jwt.decode(    #VERIFY TOKEN
            token,
            signing_key,
...
def get_current_user(
    ...
    try:
        ...
        print("INVALID TOKEN ERROR:", repr(exc))
        raise HTTPException(
            status_code=status.HTTP_401_UNAUTHORIZED,
        ...
        print("JWT VERIFICATION ERROR:", repr(exc))
